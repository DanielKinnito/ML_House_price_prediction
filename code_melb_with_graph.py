...
# Visualization
def plot_results(model_name, preds, actual):
...
plot_results("Linear Regression", linear_preds_test, test_y)
plot_results("Ridge Regression", ridge_preds_test, test_y)
plot_results("SVR", svr_preds_test, test_y)